...
In addition to the Diataxis framework, different document types serve specific purposes:

| Document Type | When to Use | Template |
|--------------|-------------|----------|
| **README** | Project overview, quick start, installation | [readme-template.md](./references/readme-template.md) |
| **API Documentation** | Endpoint/function reference with parameters, responses, errors | [api-template.md](./references/api-template.md) |
| **Code Comments** | Inline explanations of "why" (not "what") | See style guide below |
| **Architecture Docs** | System overview, component relationships, data flow, trade-offs | Use Explanation type in `docs/concepts/` |
...
Cover these aspects in `docs/concepts/architecture.md`:
...
- [references/readme-template.md](./references/readme-template.md) — README template with standard sections
- [references/api-template.md](./references/api-template.md) — API endpoint documentation template
- [references/style-guide.md](./references/style-guide.md) — Writing style and formatting guidelines
```
