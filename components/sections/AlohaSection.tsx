    ...
    <section className="bg-[var(--background)] px-6 pt-16 pb-[100px] lg:px-12 lg:pt-20" aria-label="About me">
      ...
      >
        ...
        <div className="mt-8 space-y-6 text-lg leading-[140%] text-[var(--foreground)]/90">
          <p>
            I&apos;m Stefan Heißenberg.
            <br />
            Fifteen years designing digital products across agencies, consulting, startups, and enterprise. At{" "}
            ...
            I worked with clients like Bayer, BIONTECH, and OBI. Then I joined{" "}
            <a
            ...
            as the founding designer — DHL&apos;s logistics startup where I first learned to connect UX and business
            metrics.
          </p>
          <p>
